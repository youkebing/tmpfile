...
#define  PWM1_SW(Pin)					{EAXSFR(); PWMA_PS = (PWMA_PS & 0xFC) | (Pin); EAXRAM();}
#define  PWM2_SW(Pin)					{EAXSFR(); PWMA_PS = (PWMA_PS & 0xF3) | (Pin << 2); EAXRAM();}
#define  PWM3_SW(Pin)					{EAXSFR(); PWMA_PS = (PWMA_PS & 0xCF) | (Pin << 4); EAXRAM();}
#define  PWM4_SW(Pin)					{EAXSFR(); PWMA_PS = (PWMA_PS & 0x3F) | (Pin << 6); EAXRAM();}

#define  PWM5_SW(Pin)					{EAXSFR(); PWMB_PS = (PWMB_PS & 0xFC) | (Pin); EAXRAM();}
#define  PWM6_SW(Pin)					{EAXSFR(); PWMB_PS = (PWMB_PS & 0xF3) | (Pin << 2); EAXRAM();}
#define  PWM7_SW(Pin)					{EAXSFR(); PWMB_PS = (PWMB_PS & 0xCF) | (Pin << 4); EAXRAM();}
#define  PWM8_SW(Pin)					{EAXSFR(); PWMB_PS = (PWMB_PS & 0x3F) | (Pin << 6); EAXRAM();}

#define  PWMA_ETR_SW(Pin)			{EAXSFR(); PWMA_ETRPS = (PWMA_ETRPS & 0xFC) | (Pin); EAXRAM();}
#define  PWMB_ETR_SW(Pin)			{EAXSFR(); PWMB_ETRPS = (PWMB_ETRPS & 0xFC) | (Pin); EAXRAM();}

#define  PWMA_BRK_SW(Pin)			{EAXSFR(); PWMA_ETRPS = (PWMA_ETRPS & 0xFB) | (Pin << 2); EAXRAM();}
#define  PWMB_BRK_SW(Pin)			{EAXSFR(); PWMB_ETRPS = (PWMB_ETRPS & 0xFB) | (Pin << 2); EAXRAM();}
